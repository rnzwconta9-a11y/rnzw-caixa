...
class AppState: ObservableObject {
    ...
    private func maybeAutoRunKernelExploit() {
        ...
        log("app: starting kernel access automatically")
        ...
        if KernelExploit.requiresSandboxEscape {
            if KernelExploit.hasSandboxAccess() {
                if !exploitStatus.isSuccess {
                    ...
                    log("app: existing sandbox access is active")
                }
    ...
    func runKernelExploitIfNeeded() {
        ...
        exploitStatus = .notStarted
        log("app: running kernel access on background...")
        DispatchQueue.global(qos: .userInitiated).async {
            ...
            DispatchQueue.main.async {
                ...
                if ok {
                    ...
                    log("app: kernel access active")
                } else {
                    self.exploitStatus = .failed(method: "kexploit", code: -1)
                    log("app: kernel access failed — relaunch before retrying")
                }
            }
        }
    }
